            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Create Schedule</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="#">
                  <span class="float-left">Add new schedule to driver</span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">View Schedule</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="#">
                  <span class="float-left">Look at existing schedule</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                </a>
              ...
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Update Schedule</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="#">
                  <span class="float-left">Update driver schedule</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                </a>
              ...
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Remove Schedule</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="#">
                  <span class="float-left">Remove existed schedule</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                </a>
